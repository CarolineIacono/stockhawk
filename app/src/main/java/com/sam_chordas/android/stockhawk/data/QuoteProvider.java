...
//        builder.withValue(QuoteHistorical.SYMBOL, quote.getSymbol());
//        builder.withValue(QuoteHistorical.BIDPRICE, quote.getOpen());
//        builder.withValue(QuoteHistorical.DATE, quote.getDate());
//        return builder.build();
//    }
//
